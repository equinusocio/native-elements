module.exports = {
  /* Border API */
  '--codeBorder': 'var(--ne-code-border, 1px solid hsl(0, 0%, 89%))',

  /* Background API */
  '--codeBackground': 'var(--ne-code-background, transparent)',

  /* Foreground API */
  '--codeForeground': 'var(--ne-code-foreground, hsl(220, 10%, 50%))',
